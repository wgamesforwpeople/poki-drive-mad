...
function initPokiSdk(){if(!pokiDebug){
// Sitelock check removed
...
function pokiSendLevelData(){console.log('poki leveldata disabled');}
...
async function performRequest(url,useToken,parseJson){url=encodeURI(url);simpleLogC(`performRequest(${url}, ${useToken}, ${parseJson})`);let idToken=null;if(useToken){throw"error-no-user";}
